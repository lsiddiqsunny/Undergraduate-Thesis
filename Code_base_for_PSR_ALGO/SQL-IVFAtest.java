...
public class dummy{
private static java.util.Vector traverseInputTree(java.util.Vector vectorTree, java.util.Vector returnVector){
...
java.sql.PreparedStatement ps0 = stmt.getConnection().prepareStatement(PSqueryUniqueID0);
